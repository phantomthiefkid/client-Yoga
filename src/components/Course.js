...
import { deleteCourse, getAllCourses, updateCourse } from '../helper/courseHelper';
...
export default function Dashboard() {
    ...
    const handleUpdate = async (event) => {
        ...
        try {
            const response = await updateCourse(updatedData._id, updatedData); // Call your update function to update the user data
            setShowModal(false);
            fetchData()
        } catch (error) {
            console.error(error);
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <form>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <input type="text" name="starttime" value={updatedData.startTime} onChange={handleChange}
                                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        />
                                    </div>
